...
#End Region
    ...
    Private Sub fillMonths()
        ...
        Next
        ddMonth.SelectedValue = Date.Today.Month.ToString
        ddMonth.DataBind()
    End Sub
    ...
    Private Sub fillYears()
        ...
        For i As Integer = (2003) To (Date.Today.Year + 5)
            ...
            ddYear.Items.Add(it)
        Next
        ddYear.SelectedValue = Date.Today.Year.ToString
        ddYear.DataBind()
    End Sub
    Private Sub fillYearsAMS()
        Dim it As ListItem
        For i As Integer = 1995 To 2003
            it = New ListItem
            it.Value = i.ToString
            it.Text = i.ToString
            ddYear.Items.Add(it)
