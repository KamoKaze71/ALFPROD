...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents btn_mv_sales_refresh As System.Web.UI.WebControls.Button
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        myJs.ConfirmMessage = "This will refresh all MVs in ALF (takes about 10 min)! Are you sure you want to do that?"
        myJs.AddGetConfirm(btn_mv_refresh)

        myJs.ConfirmMessage = "This will refresh only MV Sales (takes about 1 min)! Are you sure you want to do that?"
        myJs.AddGetConfirm(btn_mv_sales_refresh)
    End Sub
    ...
    Private Sub btn_mv_refresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mv_refresh.Click
        ...
        End Try
    End Sub
    Private Sub btn_mv__sales_refresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_mv_sales_refresh.Click
        Dim MyCmd As New OracleCommand
        Dim MyConn As New MyConnection
        Dim val As Object
        ...
        Try
            MyCmd.Parameters.Clear()
            MyCmd.CommandType = CommandType.StoredProcedure
            MyCmd.CommandText = "PKG_IMPORT_SANOVA.F_REFRESH_MV_SALES"
            MyCmd.Parameters.Add("v_result", OracleDbType.Varchar2, 2000, val, ParameterDirection.ReturnValue)
            MyCmd.Connection = MyConn.Open
            val = MyCmd.ExecuteScalar()
            val = MyCmd.Parameters(0).Value
