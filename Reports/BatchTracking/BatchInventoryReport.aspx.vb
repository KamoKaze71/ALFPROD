...
Public Class BatchInventoryReport
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            MyDatePopup.PageURL = "../../util/datepicker.aspx"
    ...
    Private Sub bindData()
        ...
        MyGrid.DataSource = MyReport.GetBatchInventoryReport(ddproduct, Me)
        MyGrid.DataBind()
    End Sub
    ...
    Private Sub MyGrid_ItemDataBound(ByVal sender As Object, ByVal e As C1.Web.C1WebGrid.C1ItemEventArgs) Handles MyGrid.ItemDataBound
        ...
        myCheckbox.ToolTip = "Quarantine:" & Replace(e.Item.Cells(6).Text, "&nbsp;", "sellable") & vbCrLf & "Description:" & Replace(e.Item.Cells(7).Text, "&nbsp;", "released")
