...
'''         <version>1.0</version>
''' <summary><para>Provides Oraacle native Database Connection (ODP.NET) for the whole ALF Apllication</para></summary>
Public Class MyConnection

    Private conn As New OracleConnection
    Private m_str_connection As String    ' apply default connection string here
