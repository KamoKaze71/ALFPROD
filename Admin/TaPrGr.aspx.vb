...
#Region " Web Form Designer Generated Code "
	...
	Protected WithEvents txttapg_id As System.Web.UI.WebControls.TextBox
	Protected WithEvents txttapg_description As System.Web.UI.WebControls.TextBox
...
#End Region
	...
	Private Sub BindData()
		...
		MyGrid.DataSource = MySalesRep.GetTargetProductGroups()
		MyGrid.DataBind()
	End Sub
	...
	Public Sub MyGrid_ItemCommand(ByVal sender As Object, ByVal e As C1.Web.C1WebGrid.C1CommandEventArgs) Handles MyGrid.ItemCommand
		...
		If e.CommandName = "Delete" Then
			MySalesRep.TaPgId = e.Item.Cells(0).Text

			If (MySalesRep.deleteTaPg()) Then
				BindData()
			Else
		...
		ElseIf Me.inpID.Value = "" Then
			...
			txttapg_id.Text = e.Item.Cells(0).Text
			txttapg_description.Text = e.Item.Cells(1).Text
	...
	Private Sub setvalues(ByVal type As String)
		If type = "update" Then
			MySalesRep.TaPgId = txttapg_id.Text
		End If
		MySalesRep.TaPgDescription = txttapg_description.Text
