...
'''         <version>1.0</version>
''' <summary><para>Application Settings</para></summary>
...
Public Class Settings
    ...
    Public Shared ReadOnly Property ALFApplicationRootPath() As String
        Get
            ...
            ElseIf System.Reflection.Assembly.GetExecutingAssembly.Location.ToString.IndexOf("alfexportservice") > 0 Then
                Return AppDomain.CurrentDomain.BaseDirectory.ToString.Substring(0, Len(AppDomain.CurrentDomain.BaseDirectory.ToString) - 21)
            Else
    ...
    Public Shared ReadOnly Property AlfServiceModeDebug() As Boolean
        Get
            If ConstantsManager.getConstant("ALFSERVICE_MODE") = "DEBUG" Then
                Return True
            Else : Return False
            End If
        End Get
