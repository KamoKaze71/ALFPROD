...
Public Class WyethImport2
    ...
    Public Shared Function ArchiveFiles(ByVal sourcepath As String, ByVal destinationpath As String) As String
        ...
        End Try
    End Function
    Public Shared Function ArchiveManualImportedFiles(ByVal sourcepath As String, ByVal destinationpath As String) As String
    ...
    End Function
    Public Function DownloadFtpFiles(ByRef FileLisBox As ListBox) As String
    ...
    Public Overloads Function SQLLoader(ByVal path As String) As String
            ...
            For Each fileName As String In fileEntries
                ...
                Else
                    If m_strLog.IndexOf("failed") > 0 Or m_strLog.IndexOf("failed") > 0 Or m_strLog.IndexOf("nicht") > 0 Then
                        m_strLog += "<font color=red>The File " & fileName & " could not be loaded into the Database!</font>" & vbNewLine
                    Else
        ...
        Catch ex As Exception
            m_strLog = m_strLog & "<font color=red>" & ex.message & "</font>"
            Return m_strLog
        End Try
        Return m_strLog
    End Function
