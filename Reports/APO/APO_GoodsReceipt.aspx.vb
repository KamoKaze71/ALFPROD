...
#End Region
    ...
    Private Sub BindData()
        ...
        Me.MyGrid.DataSource = myReport.GetAPO_goodsreceipt()
        Me.MyGrid.DataBind()
    ...
    Private Sub Item_DataBound(ByVal sender As Object, ByVal e As C1.Web.C1WebGrid.C1ItemEventArgs) Handles MyGrid.ItemDataBound
        sumUnits = sumUnits + CInt(e.Item.Cells(6).Text)
    End Sub
    ...
    Private Sub BUTTON1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BUTTON1.Click
        ...
        If Page.IsValid = True Then
            ...
            Dim myExport As New Exporter("Goods receipt")
