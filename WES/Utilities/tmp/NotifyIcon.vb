...
Public Class SystemTrayNotifyIcon
    ...
    Private notifyIcon As New   '= new NotifyIcon();	// NotifyIcon object
    ...
    '/// ContextMenu = SystemTrayNotifyIcon class generated menu (Default).
    '/// </summary>
    Public Sub SystemTrayNotifyIcon(ByVal form As System.Windows.Forms, ByVal visible As Boolean, ByVal toolTip As String, ByVal icon As Icon)
