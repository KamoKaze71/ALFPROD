...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MEC.aspx.vb" Inherits="Wyeth.Alf.MEC"%>
...
<TABLE ID=Table2>
  <TR>
    ...
    <TD align=center width="100%">
      <DIV CLASS=noprint><ASP:DROPDOWNLIST id=ddMonthEnd RUNAT="server" WIDTH="192px"></ASP:DROPDOWNLIST><ASP:BUTTON id=btn_Invoices RUNAT="server" CSSCLASS="button" WIDTH="144px" CAUSESVALIDATION="False" HEIGHT="19px" TEXT="Process Invoices"></ASP:BUTTON>&nbsp; 
