	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table width="100%" height="100%">
				<tr>
					<td style="WIDTH: 100%; HEIGHT: 38px"><ASP:DROPDOWNLIST id="ddTransmissions" CSSCLASS="formfield" RUNAT="server" Width="100%"></ASP:DROPDOWNLIST></td>
				...
				<tr>
					<td colspan="2" valign="top"><asp:Label ID="lblOut" Runat="server"></asp:Label></td>
				</tr>
			</table>
		</form>
	</body>
