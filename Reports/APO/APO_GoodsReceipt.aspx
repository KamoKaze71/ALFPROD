...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="APO_GoodsReceipt.aspx.vb" Inherits="Wyeth.Alf.APO_GoodsReceipt"%>
		...
		<form id="Form1" method="post" runat="server">
			...
			<c1webgrid:c1webgrid id="MyGrid" name="MyGrid" runat="server" width="100%" AutoGenerateColumns="False"
				...
				<Columns>
					...
					<c1webgrid:C1BoundColumn HeaderText="Plant" DataField="zplanttcc"></c1webgrid:C1BoundColumn>
					...
					<c1webgrid:C1BoundColumn HeaderText="Date received" DataField="zgr_dte"></c1webgrid:C1BoundColumn>
					<c1webgrid:C1BoundColumn HeaderText="Quantity" DataField="zafgrqty">
