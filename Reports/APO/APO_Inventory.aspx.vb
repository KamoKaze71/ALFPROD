...
#End Region
    ...
    Dim sumUnits, sumBlocked, sumRestricted, sumUnrestricted, sumQltyInsp As Integer
    ...
    Private Sub BindData()
        ...
        Me.MyGrid.DataSource = myReport.GetAPO_Inventory()
        Me.MyGrid.DataBind()
    ...
    Private Sub Item_DataBound(ByVal sender As Object, ByVal e As C1.Web.C1WebGrid.C1ItemEventArgs) Handles MyGrid.ItemDataBound
        ...
        sumBlocked = sumBlocked + CInt(e.Item.Cells(10).Text)
        sumRestricted = sumRestricted + CInt(e.Item.Cells(11).Text)
        sumUnrestricted = sumUnrestricted + CInt(e.Item.Cells(6).Text)
        sumQltyInsp = sumQltyInsp + CInt(e.Item.Cells(12).Text)
    End Sub
    Private Sub Item_Created(ByVal sender As Object, ByVal e As C1.Web.C1WebGrid.C1ItemEventArgs) Handles MyGrid.ItemCreated
        If e.Item.ItemType = C1.Web.C1WebGrid.C1ListItemType.Footer Then
            ...
            e.Item.Cells(6).Text = sumUnrestricted
            e.Item.Cells(10).Text = sumBlocked
            e.Item.Cells(11).Text = sumRestricted
            e.Item.Cells(12).Text = sumQltyInsp
