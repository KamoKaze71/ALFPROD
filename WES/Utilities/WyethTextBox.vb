...
Public Class WyethTextBox
    ...
    '    Dim strError, strScript As String
    '    strError = Me.FriendlyName.ToString & ": " & Me.ErrorMessage.ToString()
    '    strScript += "<script language =javascript >"
    '    strScript += "function AlertErrors(){"
    '    strScript += "alert('" & strError & "')"
    '    strScript += "</script>"

    '    Me.Context.Current.Response.Write(strScript)

    '    Page.RegisterStartupScript("OnLoad", strScript)

    '    System.Web.UI.RegisterClientScriptBlock("anything", strScript)
