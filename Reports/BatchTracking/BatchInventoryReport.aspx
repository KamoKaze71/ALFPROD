<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BatchInventoryReport.aspx.vb" Inherits="Wyeth.Alf.BatchInventoryReport"%>
...
<HTML>
	<HEAD>
		<title>BatchInventoryReport</title>
				...
				<DIV class="noprint">
					<TABLE class="reportsFilter" cellSpacing="0" cellPadding="0" width="100%">
						<TR>
							...
							<TD>Batch No.:&nbsp;
								<box:wyethtextbox id="txtBatchNr" Runat="server" AllowBlank="true" FieldType="Text"></box:wyethtextbox></TD>
						</TR>
					</TABLE>
				</DIV>
