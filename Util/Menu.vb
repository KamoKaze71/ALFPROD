...
Public Class Menu
    ...
    '    MenuIDParent = eventArgument.ToString
    'End Sub
    ...
    '    Dim strHtml, strScript, str_showMouseover, str_showimage As String
    '    Dim height, width As Integer

    '    If CssStyleHover <> "" Then
    '        str_showMouseover = " class=" & CssStyle & " onMouseOver=""this.className='" & CssStyleHover & "';"" onMouseOut=""this.className='" & CssStyle & "';"""
    '    End If
    ...
    '        Dim img As New System.Drawing.Bitmap(path & m_strTabImage)     'System.Web.UI.HtmlControls.HtmlImage
    '        height = img.Height
    '        width = img.Width
    '        str_showimage = " width=" & width & "px  height=" & height & "px align=center background='images/" & m_strTabImage & "'"
    ...
    '        strHtml = "<table cellspacing=3 cellpadding=3> <tr>"

    '        Do While MyReader.Read

    '            strHtml = strHtml & "<td" & str_showMouseover & str_showimage & "><A href='" & MyReader("menu_link") & "' target='" & MyReader("menu_target") & "'  >" & MyReader("menu_label") & "</a></td>"
    '            strHtml = strHtml & "<td" & str_showMouseover & str_showimage & "><A href=""" & "javascript:" + Page.GetPostBackEventReference(Me, MyReader("menu_id_parent")) & """ target='" & MyReader("menu_target") & "'  >" & MyReader("menu_label") & "</a></td>"
    ...
    '        strHtml = "<table cellspacing=3 cellpadding=3 width='" & MenuWidth & "'> "

    '        Do While MyReader.Read

    '            strHtml = strHtml & "<tr class=" & CssStyle & " " & str_showMouseover & str_showimage & "><td align=center><A href='" & MyReader("menu_link") & "' target='" & MyReader("menu_target") & "'  >" & MyReader("menu_label") & "</a></td></tr>"
