				...
				<tr>
					<td>
						<table height="100%" ALIGN="center">
							...
							<tr>
								<td><asp:button id="button_forte_product_groups" runat="server" CssClass="button_common" Text="Forte Product Groups"
										Width="320px"></asp:button></td>
							</tr>
							<tr>
								<td><asp:button id="button_forte_gm_layout" runat="server" CssClass="button_common" Text="Forte GM-Layout"
										Width="320px"></asp:button></td>
							</tr>
							<tr>
