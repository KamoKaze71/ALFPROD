...
#End Region
    ...
    Dim ed, sd, phznr, presentation, type As String
	...
	Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Me.ViewState.Add("type", type)
            If type = "" Then

                BindData()
            Else
                Me.lblPageTitle.Text = "Stock Sample Conversions"
                BindDataUM()
            End If
        End If
	End Sub
    Private Sub BindData()
        ...
        MyGrid.DataSource = MyStock.GetStockKORR()
        MyGrid.DataBind()
        SetGridStyles(MyGrid)

    End Sub

    Private Sub BindDataUM()
        repData.addLine("Start Date", FormatDate(sd), True, True)
        repData.addLine("End Date", FormatDate(ed), True, True)
        repData.addLine("Presentation", presentation, True, True)
        ...
        MyStock.StockProdID = prod_id
        MyStock.StockDistID = dist_id
        MyStock.StockCodeIDBewegKZ = MyStock.GetCodeIDBewegKZ(type.ToUpper)
        MyGrid.DataSource = MyStock.GetStockKORRByCodeIDBewegKZ()
        MyGrid.DataBind()
        SetGridStyles(MyGrid)
    ...
    Private Sub Item_created(ByVal sender As Object, ByVal e As C1.Web.C1WebGrid.C1ItemEventArgs) Handles MyGrid.ItemCreated
        ...
        ElseIf e.Item.ItemType = C1.Web.C1WebGrid.C1ListItemType.Footer Then
            ...
            e.Item.Cells(5).Text = sum1.ToString(NUMBER_FORMAT_STRING)
            e.Item.Cells(7).Text = sum2.ToString(NUMBER_FORMAT_STRING_EXACT)
