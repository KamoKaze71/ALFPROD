...
#End Region
    ...
    Private Sub BindData()
        ...
        MyStock.StockLineID = 1
        MyStock.StockProdID = prod_id
        MyStock.StockDistID = dist_id
        MyGrid.DataSource = MyStock.GetStockOUT()

        'MyGrid.VScrollBarStyle = C1.Web.C1WebGrid.C1ScrollBarStyle.Automatic
